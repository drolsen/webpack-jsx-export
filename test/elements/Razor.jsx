...
class Model extends React.Component {
  ...
  render() {
    ...
    if (use) {
      return (
        <React.Fragment>{`@Model.${use}`}</React.Fragment> // eslint-disable-line
      );
    }
...
class Html extends React.Component {
  ...
  render() {
    ...
    return (
      <React.Fragment>{`@Html.${use}`}</React.Fragment> // eslint-disable-line
    );
  }
}
...
class Call extends React.Component {
  ...
  render() {
    ...
    return (
      <React.Fragment>{`@${use}`}</React.Fragment> // eslint-disable-line
    );
  }
}
